            ...
            {i < nutritionStrip.length - 1 && (
              <span
                ...
                style={{
                  width: "1px",
                  height: "24px",
                  background: "rgba(254,214,140,0.14)",
                }}
              />
            )}
          </div>
        ...
        <div>
          ...
          <div className="space-y-5 mb-8">
            <p className="text-[#5a3520] font-light leading-[1.95] text-sm md:text-[0.92rem]">
              We start with 73% medium roasted peanuts — slow roasted until they hit
              that perfect depth of flavour.
            </p>
            <p className="text-[#5a3520] font-light leading-[1.95] text-sm md:text-[0.92rem]">
              Then we add real chocolate paste. Not a flavouring. Not cocoa powder.
              Actual chocolate. The kind you can taste the difference in.
            </p>
            <p className="text-[#5a3520] font-light leading-[1.95] text-sm md:text-[0.92rem]">
              20 grams of protein per 100g. Zero trans fat. A texture that&apos;s rich and
          ...
          >
            ...
            >
              It&apos;s what happens when you stop compromising and start actually caring
              about what goes on your spoon.
            </p>
          </div>
          ...
          <p
            ...
            style={{ color: "#A2452B" }}
          >
            And a taste that makes you pause mid-spoon and think —
  ...
  <div className="p-5">
    ...
    >
      ...
      <p
        ...
        style={{ color: "rgba(243,236,226,0.75)" }}
      >
    ...
    <table className="w-full text-left border-collapse">
      <thead>
        <tr
          style={{
            borderBottom: "1px solid rgba(254,214,140,0.15)",
          }}
        >
          <th
            className="pb-3 text-[0.72rem] uppercase"
            style={{ color: "#FED68C" }}
          >
            Nutrient
          </th>
          ...
          <th
            className="pb-3 text-right text-[0.72rem] uppercase"
            style={{ color: "#FED68C" }}
          >
            Per 100g
          </th>
      ...
      <tbody>
        {[
          ...
          >
            ...
            <td
              className="py-3 text-right text-[0.78rem] font-medium"
              style={{ color: "#FED68C" }}
            >
              {value}
            </td>
            ...
            <td
              className="py-3 text-right text-[0.78rem]"
    ...
    <p
      className="mt-4 text-[0.65rem] leading-relaxed"
      style={{ color: "rgba(243,236,226,0.45)" }}
    >
      *Percentage RDA values are approximate and based on a standard adult diet.
            ...
            {/* <div
              className="flex flex-col items-center justify-center gap-3 mx-5 my-5 rounded-[14px]"
              style={{
                height: "260px",
                border: "1.5px dashed rgba(254,214,140,0.14)",
              }}
            >
              <span style={{ color: "rgba(254,214,140,0.18)", fontSize: "2.2rem" }}>📋</span>
              <span
                className="text-[0.62rem] font-bold uppercase tracking-[0.14em]"
                style={{ color: "rgba(254,214,140,0.22)" }}
              >
                Add nutrition label photo here
              </span>
            </div> */}
          </div>
          ...
          <div
            ...
            style={{
              background: "rgba(111,55,30,0.06)",
              border: "1px solid rgba(111,55,30,0.1)",
            }}
          >
            <p
